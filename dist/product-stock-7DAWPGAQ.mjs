...
var ProductStockForm = ({
  ...
  return /* @__PURE__ */ jsx3(RouteFocusModal.Form, { form, children: /* @__PURE__ */ jsxs2(KeyboundForm, { onSubmit, className: "flex h-full flex-col", children: [
    /* @__PURE__ */ jsx3(RouteFocusModal.Header, {}),
    /* @__PURE__ */ jsx3(RouteFocusModal.Body, { className: "flex-1", children: /* @__PURE__ */ jsx3(
      DataGrid,
      {
        state: form,
        columns,
