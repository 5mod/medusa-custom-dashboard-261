        ...
        children: [
          ...
          },
          {
            ...
            children: [
              {
                path: "",
                lazy: () => import("./product-list-ZYFCXAL7.mjs"),
                children: [
                  {
                    path: "create",
                    lazy: () => import("./product-create-QTQNR7CN.mjs")
                  },
                  {
                    path: "import",
                    lazy: () => import("./product-import-5H7WPILZ.mjs")
                  },
                  {
                    path: "export",
                    lazy: () => import("./product-export-6OPZPOSG.mjs")
                  }
                ]
              },
              {
                ...
                errorElement: /* @__PURE__ */ jsx17(ErrorBoundary, {}),
                lazy: async () => {
                  const { Breadcrumb, loader } = await import("./product-detail-65OMFTZV.mjs");
                  return {
                    Component: Outlet4,
                    loader,
                    handle: {
                ...
                children: [
                  {
                    path: "",
                    lazy: () => import("./product-detail-65OMFTZV.mjs"),
                    children: [
                      {
                        path: "edit",
                        lazy: () => import("./product-edit-WLECQLOG.mjs")
                      },
                      {
                        path: "edit-variant",
                        lazy: () => import("./product-variant-edit-LFRUDXNE.mjs")
                      },
                      {
                        path: "sales-channels",
                        lazy: () => import("./product-sales-channels-2BO6EMUE.mjs")
                      },
                      {
                        path: "attributes",
                        lazy: () => import("./product-attributes-ZNBQPND6.mjs")
                      },
                      {
                        path: "organization",
                        lazy: () => import("./product-organization-F2DQGZUX.mjs")
                      },
                      {
                        path: "shipping-profile",
                        lazy: () => import("./product-shipping-profile-5EMI7J74.mjs")
                      },
                      {
                        path: "media",
                        lazy: () => import("./product-media-GQLGYD74.mjs")
                      },
                      {
                        path: "prices",
                        lazy: () => import("./product-prices-WOP3CWDX.mjs")
                      },
                      {
                        path: "options/create",
                        lazy: () => import("./product-create-option-EQMRBGAU.mjs")
                      },
                      {
                        path: "options/:option_id/edit",
                        lazy: () => import("./product-edit-option-TL5D3WMD.mjs")
                      },
                      {
                        path: "variants/create",
                        lazy: () => import("./product-create-variant-4L6JNFZX.mjs")
                      },
                      {
                        path: "stock",
                        lazy: () => import("./product-stock-7DAWPGAQ.mjs")
                      },
                      {
                        path: "metadata/edit",
                        lazy: () => import("./product-metadata-FLXHDNTP.mjs")
                      }
                    ]
                  },
                  {
                    ...
                    lazy: async () => {
                      const { Component, Breadcrumb, loader } = await import("./product-variant-detail-BJWDJMQB.mjs");
                      return {
                        Component,
                        loader,
                        handle: {
                    ...
                    children: [
                      ...
                      {
                        path: "manage-items",
                        lazy: () => import("./product-variant-manage-inventory-items-7YK7JIV4.mjs")
                      },
                      {
                        path: "metadata/edit",
                        lazy: () => import("./product-variant-metadata-ZNEVY3UA.mjs")
                      }
                    ]
                  }
                ]
          ...
          },
          {
            ...
            children: [
              {
                path: "",
                lazy: () => import("./category-list-NYVFBSHU.mjs"),
                children: [
                  {
                    path: "create",
                    lazy: () => import("./category-create-A2P3VETX.mjs")
                  },
                  {
                    path: "organize",
                    lazy: () => import("./category-organize-HPVOQYOJ.mjs")
                  }
                ]
              },
              {
                path: ":id",
                lazy: async () => {
                  const { Component, Breadcrumb, loader } = await import("./category-detail-E5PF7QGY.mjs");
                  return {
                    Component,
                    loader,
                    handle: {
                ...
                children: [
                  {
                    path: "edit",
                    lazy: () => import("./category-edit-HMCGP6YF.mjs")
                  },
                  {
                    path: "products",
                    lazy: () => import("./category-products-QHUKGTUE.mjs")
                  },
                  {
                    path: "organize",
                    lazy: () => import("./category-organize-HPVOQYOJ.mjs")
                  ...
                  {
                    path: "metadata/edit",
                    lazy: () => import("./categories-metadata-VNQV6UNI.mjs")
                  }
                ]
              }
            ]
          },
          {
            ...
            children: [
              {
                path: "",
                lazy: () => import("./order-list-4UM37T63.mjs")
              },
              {
                path: ":id",
                lazy: async () => {
                  const { Component, Breadcrumb, loader } = await import("./order-detail-BGPS7U43.mjs");
                  return {
                    Component,
                    loader,
                    handle: {
                ...
                children: [
                  {
                    path: "fulfillment",
                    lazy: () => import("./order-create-fulfillment-Z74IQQBX.mjs")
                  },
                  {
                    path: "returns/:return_id/receive",
                    lazy: () => import("./order-receive-return-CZSFFYOM.mjs")
                  },
                  {
                    path: "allocate-items",
                    lazy: () => import("./order-allocate-items-DREIVMB2.mjs")
                  },
                  {
                    path: ":f_id/create-shipment",
                    lazy: () => import("./order-create-shipment-WKKTNOOQ.mjs")
                  },
                  {
                    path: "returns",
                    lazy: () => import("./order-create-return-NRT2CJJN.mjs")
                  },
                  {
                    path: "claims",
                    lazy: () => import("./order-create-claim-KS4XICUQ.mjs")
                  },
                  {
                    path: "exchanges",
                    lazy: () => import("./order-create-exchange-7VLYEAWX.mjs")
                  },
                  {
                    path: "edits",
                    lazy: () => import("./order-create-edit-7UB6XO2B.mjs")
                  },
                  {
                    path: "refund",
                    lazy: () => import("./order-create-refund-5LMKLZRX.mjs")
                  },
                  {
                    path: "transfer",
                    lazy: () => import("./order-request-transfer-RZGFZQD6.mjs")
                  },
                  {
                    path: "email",
                    lazy: () => import("./order-edit-email-OGKYM75C.mjs")
                  },
                  {
                    path: "shipping-address",
                    lazy: () => import("./order-edit-shipping-address-YX7QRCKH.mjs")
                  },
                  {
                    path: "billing-address",
                    lazy: () => import("./order-edit-billing-address-Q5QIATTN.mjs")
                  },
                  {
                    path: "metadata/edit",
                    lazy: () => import("./order-metadata-LN3ZWSYU.mjs")
                  }
                ]
              }
            ]
          },
          {
            ...
            children: [
              {
                path: "",
                lazy: () => import("./promotion-list-2XODRCAT.mjs")
              },
              {
                path: "create",
                lazy: () => import("./promotion-create-UFLI5VZZ.mjs")
              },
              {
                path: ":id",
                lazy: async () => {
                  const { Component, Breadcrumb, loader } = await import("./promotion-detail-7K6GHMMF.mjs");
                  return {
                    Component,
                    loader,
                    handle: {
                ...
                children: [
                  {
                    path: "edit",
                    lazy: () => import("./promotion-edit-details-3HIRPRF6.mjs")
                  },
                  {
                    path: "add-to-campaign",
                    lazy: () => import("./promotion-add-campaign-ZAQGOA2I.mjs")
                  },
                  {
                    path: ":ruleType/edit",
                    lazy: () => import("./edit-rules-R2KCUDR4.mjs")
                  }
                ]
              }
            ]
          },
          {
            ...
            children: [
              {
                path: "",
                lazy: () => import("./campaign-list-AIOAS6H7.mjs"),
                children: []
              },
              {
                path: "create",
                lazy: () => import("./campaign-create-N6Q63KPA.mjs")
              },
              {
                path: ":id",
                lazy: async () => {
                  const { Component, Breadcrumb, loader } = await import("./campaign-detail-UFKMDOCI.mjs");
                  return {
                    Component,
                    loader,
                    handle: {
                ...
                children: [
                  {
                    path: "edit",
                    lazy: () => import("./campaign-edit-3IN4ZAE6.mjs")
                  },
                  {
                    path: "configuration",
                    lazy: () => import("./campaign-configuration-763VD4TZ.mjs")
                  },
                  {
                    path: "edit-budget",
                    lazy: () => import("./campaign-budget-edit-D34CUOJO.mjs")
                  },
                  {
                    path: "add-promotions",
                    lazy: () => import("./add-campaign-promotions-NGHA6TPQ.mjs")
                  }
                ]
              }
            ]
          },
          {
            ...
            children: [
              {
                path: "",
                lazy: () => import("./collection-list-MX3JT2MM.mjs"),
                children: [
                  {
                    path: "create",
                    lazy: () => import("./collection-create-73W3PKRP.mjs")
                  }
                ]
              },
              {
                path: ":id",
                lazy: async () => {
                  const { Component, Breadcrumb, loader } = await import("./collection-detail-XZHWMXTD.mjs");
                  return {
                    Component,
                    loader,
                    handle: {
                ...
                children: [
                  {
                    path: "edit",
                    lazy: () => import("./collection-edit-XOFEAUQ3.mjs")
                  },
                  {
                    path: "products",
                    lazy: () => import("./collection-add-products-KCSTPL5V.mjs")
                  },
                  {
                    path: "metadata/edit",
                    lazy: () => import("./collection-metadata-TDN5XAH4.mjs")
                  }
                ]
              }
            ]
          },
          {
            ...
            children: [
              {
                path: "",
                lazy: () => import("./price-list-list-2OVAPQ2V.mjs"),
                children: [
                  {
                    path: "create",
                    lazy: () => import("./price-list-create-QPANOVW6.mjs")
                  }
                ]
              },
              {
                path: ":id",
                lazy: async () => {
                  const { Component, Breadcrumb, loader } = await import("./price-list-detail-5CGNKBXK.mjs");
                  return {
                    Component,
                    loader,
                    handle: {
                ...
                children: [
                  {
                    path: "edit",
                    lazy: () => import("./price-list-edit-4TRNGADZ.mjs")
                  },
                  {
                    path: "configuration",
                    lazy: () => import("./price-list-configuration-OKQX6X4B.mjs")
                  },
                  {
                    path: "products/add",
                    lazy: () => import("./price-list-prices-add-LZUTI4XL.mjs")
                  },
                  {
                    path: "products/edit",
                    lazy: () => import("./price-list-prices-edit-6R44WA3L.mjs")
                  }
                ]
              }
            ]
          },
          {
            ...
            children: [
              {
                path: "",
                lazy: () => import("./customer-list-N4OPKXNZ.mjs"),
                children: [
                  {
                    path: "create",
                    lazy: () => import("./customer-create-RHOEWABA.mjs")
                  }
                ]
              },
              {
                path: ":id",
                lazy: async () => {
                  const { Component, Breadcrumb, loader } = await import("./customer-detail-W5CPEYQG.mjs");
                  return {
                    Component,
                    loader,
                    handle: {
                ...
                children: [
                  {
                    path: "edit",
                    lazy: () => import("./customer-edit-UJ3HIJY5.mjs")
                  },
                  {
                    path: "add-customer-groups",
                    lazy: () => import("./customers-add-customer-group-4AD5UAQN.mjs")
                  },
                  {
                  ...
                  {
                    path: "metadata/edit",
                    lazy: () => import("./customer-metadata-LP542XUW.mjs")
                  }
                ]
              }
            ]
          },
          {
            ...
            children: [
              {
                path: "",
                lazy: () => import("./customer-group-list-42QB5QPN.mjs"),
                children: [
                  {
                    path: "create",
                    lazy: () => import("./customer-group-create-QSJW43LD.mjs")
                  }
                ]
              },
              {
                path: ":id",
                lazy: async () => {
                  const { Component, Breadcrumb, loader } = await import("./customer-group-detail-DWG56XGI.mjs");
                  return {
                    Component,
                    loader,
                    handle: {
                ...
                children: [
                  {
                    path: "edit",
                    lazy: () => import("./customer-group-edit-6YTAL47N.mjs")
                  },
                  {
                    path: "add-customers",
                    lazy: () => import("./customer-group-add-customers-XZKZ7UCA.mjs")
                  },
                  {
                    path: "metadata/edit",
                    lazy: () => import("./customer-group-metadata-QQBER3SQ.mjs")
                  }
                ]
              }
            ]
          },
          {
            ...
            children: [
              {
                path: "",
                lazy: () => import("./reservation-list-EG3KZJ43.mjs"),
                children: [
                  {
                    path: "create",
                    lazy: () => import("./reservation-create-O7JYXKPW.mjs")
                  }
                ]
              },
              {
                path: ":id",
                lazy: async () => {
                  const { Component, Breadcrumb, loader } = await import("./reservation-detail-73DGBDFW.mjs");
                  return {
                    Component,
                    loader,
                    handle: {
                ...
                children: [
                  {
                    path: "edit",
                    lazy: () => import("./edit-reservation-6GTC3BSP.mjs")
                  },
                  {
                    path: "metadata/edit",
                    lazy: () => import("./reservation-metadata-V64BQG3U.mjs")
                  }
                ]
              }
            ]
          },
          {
            ...
            children: [
              {
                path: "",
                lazy: () => import("./inventory-list-LUMMXDAR.mjs"),
                children: [
                  {
                    path: "create",
                    lazy: () => import("./inventory-create-7BJFF5TC.mjs")
                  },
                  {
                    path: "stock",
                    lazy: () => import("./inventory-stock-4IC272BI.mjs")
                  }
                ]
              },
              {
                path: ":id",
                lazy: async () => {
                  const { Component, Breadcrumb, loader } = await import("./inventory-detail-AHNNOFDP.mjs");
                  return {
                    Component,
                    loader,
                    handle: {
                ...
                children: [
                  {
                    path: "edit",
                    lazy: () => import("./edit-inventory-item-7WTD2V3O.mjs")
                  },
                  {
                    path: "attributes",
                    lazy: () => import("./edit-inventory-item-attributes-TDTU2TXF.mjs")
                  },
                  {
                    path: "metadata/edit",
                    lazy: () => import("./inventory-metadata-JN4UGA4I.mjs")
                  },
                  {
                    path: "locations",
                    lazy: () => import("./manage-locations-MGN27OOP.mjs")
                  },
                  {
                    path: "locations/:location_id",
                    lazy: () => import("./adjust-inventory-CYZ5QHHN.mjs")
                  }
                ]
              }
            ]
        ...
        children: [
          {
            index: true,
            errorElement: /* @__PURE__ */ jsx17(ErrorBoundary, {}),
            lazy: () => import("./settings-PXPJHK7N.mjs")
          },
          {
            path: "profile",
            errorElement: /* @__PURE__ */ jsx17(ErrorBoundary, {}),
            lazy: () => import("./profile-detail-ISM6XBPQ.mjs"),
            handle: {
            ...
            children: [
              {
                path: "edit",
                lazy: () => import("./profile-edit-75NXNI7X.mjs")
              }
            ]
          },
          {
            ...
            children: [
              {
                path: "",
                lazy: () => import("./region-list-WRVZ4G7V.mjs"),
                children: [
                  {
                    path: "create",
                    lazy: () => import("./region-create-PJN4QOQV.mjs")
                  }
                ]
              },
              {
                path: ":id",
                lazy: async () => {
                  const { Component, Breadcrumb, loader } = await import("./region-detail-P2FLI4J3.mjs");
                  return {
                    Component,
                    loader,
                    handle: {
                ...
                children: [
                  {
                    path: "edit",
                    lazy: () => import("./region-edit-MQZF2YDU.mjs")
                  },
                  {
                    path: "countries/add",
                    lazy: () => import("./region-add-countries-VRE3NLI7.mjs")
                  },
                  {
                    path: "metadata/edit",
                    lazy: () => import("./region-metadata-F3XFXHCE.mjs")
                  }
                ]
              }
            ]
          },
          {
            path: "store",
            errorElement: /* @__PURE__ */ jsx17(ErrorBoundary, {}),
            lazy: () => import("./store-detail-VQVYBAXA.mjs"),
            handle: {
            ...
            children: [
              {
                path: "edit",
                lazy: () => import("./store-edit-VG46QDL4.mjs")
              },
              {
                path: "currencies",
                lazy: () => import("./store-add-currencies-55IZQDXT.mjs")
              },
              {
                path: "metadata/edit",
                lazy: () => import("./store-metadata-MPCIOU4O.mjs")
              }
            ]
          },
          {
            ...
            children: [
              {
                path: "",
                lazy: () => import("./user-list-AN6KOGTT.mjs"),
                children: [
                  {
                    path: "invite",
                    lazy: () => import("./user-invite-LO42MF7A.mjs")
                  }
                ]
              },
              {
                path: ":id",
                lazy: async () => {
                  const { Component, Breadcrumb, loader } = await import("./user-detail-CD5D5CXU.mjs");
                  return {
                    Component,
                    loader,
                    handle: {
                ...
                children: [
                  {
                    path: "edit",
                    lazy: () => import("./user-edit-VJBDPSYG.mjs")
                  },
                  {
                    path: "metadata/edit",
                    lazy: () => import("./user-metadata-BCAP3QV7.mjs")
                  }
                ]
              }
            ]
          },
          {
            ...
            children: [
              {
                path: "",
                lazy: () => import("./sales-channel-list-S4SEYBSS.mjs"),
                children: [
                  {
                    path: "create",
                    lazy: () => import("./sales-channel-create-XEGNHI5B.mjs")
                  }
                ]
              },
              {
                path: ":id",
                lazy: async () => {
                  const { Component, Breadcrumb, loader } = await import("./sales-channel-detail-EI74DOFS.mjs");
                  return {
                    Component,
                    loader,
                    handle: {
                ...
                children: [
                  {
                    path: "edit",
                    lazy: () => import("./sales-channel-edit-YTBXYK5K.mjs")
                  },
                  {
                    path: "add-products",
                    lazy: () => import("./sales-channel-add-products-NX5LNNMG.mjs")
                  },
                  {
                    path: "metadata/edit",
                    lazy: () => import("./sales-channel-metadata-KYOKZ2LG.mjs")
                  }
                ]
              }
            ]
          },
          {
            ...
            children: [
              {
                path: "",
                lazy: () => import("./location-list-D7FDGHWC.mjs")
              },
              {
                path: "create",
                lazy: () => import("./location-create-UDXN23UD.mjs")
              },
              {
                ...
                children: [
                  {
                    path: "",
                    lazy: () => import("./shipping-profiles-list-PXN4QVVH.mjs"),
                    children: [
                      {
                        path: "create",
                        lazy: () => import("./shipping-profile-create-BXA7DHCH.mjs")
                      }
                    ]
                  },
                  {
                    ...
                    lazy: async () => {
                      const { Component, Breadcrumb, loader } = await import("./shipping-profile-detail-EVV3SQBJ.mjs");
                      return {
                        Component,
                        loader,
                        handle: {
                    ...
                    children: [
                      {
                        path: "metadata/edit",
                        lazy: () => import("./shipping-profile-metadata-P6R6IB6U.mjs")
                      }
                    ]
                  }
                ]
              },
              {
                path: ":location_id",
                lazy: async () => {
                  const { Component, Breadcrumb, loader } = await import("./location-detail-YGJ5HPWG.mjs");
                  return {
                    Component,
                    loader,
                    handle: {
                ...
                children: [
                  {
                    path: "edit",
                    lazy: () => import("./location-edit-32CGKV4F.mjs")
                  },
                  {
                    path: "sales-channels",
                    lazy: () => import("./location-sales-channels-7I2C6LNE.mjs")
                  },
                  {
                    path: "fulfillment-providers",
                    lazy: () => import("./location-fulfillment-providers-NFB6AUNO.mjs")
                  },
                  {
                    ...
                    children: [
                      {
                        ...
                        lazy: () => import("./location-service-zone-create-TZFNRCTI.mjs")
                      },
                      {
                        ...
                        children: [
                          {
                            path: "edit",
                            lazy: () => import("./location-service-zone-edit-HV4TFZYV.mjs")
                          },
                          {
                            path: "areas",
                            lazy: () => import("./location-service-zone-manage-areas-3A6IOXFC.mjs")
                          },
                          {
                            ...
                            children: [
                              {
                                path: "create",
                                lazy: () => import("./location-service-zone-shipping-option-create-XNN7SMZP.mjs")
                              },
                              {
                                path: ":so_id",
                                children: [
                                  {
                                    path: "edit",
                                    lazy: () => import("./location-service-zone-shipping-option-edit-UUAZOPBX.mjs")
                                  },
                                  {
                                    path: "pricing",
                                    lazy: () => import("./location-service-zone-shipping-option-pricing-BDPYLGZ7.mjs")
                                  }
                                ]
                              }
                            ]
          ...
          },
          {
            ...
            children: [
              {
                path: "",
                lazy: () => import("./product-tag-list-7YIAWRKO.mjs"),
                children: [
                  {
                    path: "create",
                    lazy: () => import("./product-tag-create-2KS3LLZF.mjs")
                  }
                ]
              },
              {
                path: ":id",
                lazy: async () => {
                  const { Component, Breadcrumb, loader } = await import("./product-tag-detail-ICIGHY5A.mjs");
                  return {
                    Component,
                    loader,
                    handle: {
                ...
                children: [
                  {
                    path: "edit",
                    lazy: () => import("./product-tag-edit-5CWABXWD.mjs")
                  }
                ]
              }
            ]
          },
          {
            ...
            children: [
              {
                path: "",
                lazy: () => import("./workflow-execution-list-NJE47DYT.mjs")
              },
              {
                path: ":id",
                lazy: async () => {
                  const { Component, Breadcrumb, loader } = await import("./workflow-execution-detail-FW5PDH4G.mjs");
                  return {
                    Component,
                    loader,
                    handle: {
          ...
          },
          {
            ...
            children: [
              {
                path: "",
                lazy: () => import("./product-type-list-HBHNTCBQ.mjs"),
                children: [
                  {
                    path: "create",
                    lazy: () => import("./product-type-create-7R32GYKP.mjs")
                  }
                ]
              },
              {
                path: ":id",
                lazy: async () => {
                  const { Component, Breadcrumb, loader } = await import("./product-type-detail-EEA7H472.mjs");
                  return {
                    Component,
                    loader,
                    handle: {
                ...
                children: [
                  {
                    path: "edit",
                    lazy: () => import("./product-type-edit-SZK6WTXJ.mjs")
                  }
                ]
              }
            ]
            ...
            children: [
              {
                ...
                children: [
                  {
                    path: "",
                    lazy: () => import("./api-key-management-list-VF7CTGZF.mjs"),
                    children: [
                      {
                        path: "create",
                        lazy: () => import("./api-key-management-create-Y6WSXSXC.mjs")
                      }
                    ]
                  }
                ]
              },
              {
                path: ":id",
                lazy: async () => {
                  const { Component, Breadcrumb, loader } = await import("./api-key-management-detail-27CSV54B.mjs");
                  return {
                    Component,
                    loader,
                    handle: {
                ...
                children: [
                  {
                    path: "edit",
                    lazy: () => import("./api-key-management-edit-G56CQOSN.mjs")
                  },
                  {
                    path: "sales-channels",
                    lazy: () => import("./api-key-management-sales-channels-CG5EW2VS.mjs")
                  }
                ]
              }
            ]
          ...
          },
          {
            ...
            children: [
              {
                path: "",
                lazy: () => import("./tax-region-list-E773YFDJ.mjs"),
                children: [
                  {
                    path: "create",
                    lazy: () => import("./tax-region-create-O5XMR5LE.mjs")
                  }
                ]
              },
              {
                ...
                children: [
                  {
                    path: "",
                    lazy: async () => {
                      const { Component } = await import("./tax-region-detail-RUY5WYUI.mjs");
                      return {
                        Component
                      };
                    },
                    children: [
                      {
                        ...
                        lazy: () => import("./tax-region-province-create-J4TB3DIH.mjs")
                      },
                      {
                        path: "overrides/create",
                        lazy: () => import("./tax-region-tax-override-create-VQFFPH53.mjs")
                      },
                      {
                        path: "overrides/:tax_rate_id/edit",
                        lazy: () => import("./tax-region-tax-override-edit-OQPCUODO.mjs")
                      },
                      {
                        path: "tax-rates/create",
                        lazy: () => import("./tax-region-tax-rate-create-JWN6HGOF.mjs")
                      },
                      {
                        path: "tax-rates/:tax_rate_id/edit",
                        lazy: () => import("./tax-region-tax-rate-edit-ODZUQCY5.mjs")
                      }
                    ]
                  },
                  {
                    ...
                    lazy: async () => {
                      const { Component, Breadcrumb, loader } = await import("./tax-region-province-detail-T7VRMYIQ.mjs");
                      return {
                        Component,
                        loader,
                        handle: {
          ...
          },
          {
            ...
            children: [
              {
                path: "",
                lazy: () => import("./return-reason-list-WOYDPJ7P.mjs"),
                children: [
                  {
                    path: "create",
                    lazy: () => import("./return-reason-create-5BJYFLM6.mjs")
                  },
                  {
                    path: ":id",
                    children: [
                      {
                        path: "edit",
                        lazy: () => import("./return-reason-edit-YLNMU7EU.mjs")
                      }
                    ]
                  }
                ]
    ...
    children: [
      {
        ...
        children: [
          {
            path: "/login",
            lazy: () => import("./login-OGJEWOBP.mjs")
          },
          {
            path: "/reset-password",
            lazy: () => import("./reset-password-YGIF4L3S.mjs")
          },
          {
            path: "/invite",
            lazy: () => import("./invite-MP4B6XIW.mjs")
          },
          {
            path: "*",
            lazy: () => import("./no-match-E3I4SUZ7.mjs")
          }
        ]
      }
    ]
